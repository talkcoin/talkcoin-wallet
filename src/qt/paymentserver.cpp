...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click talkcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start talkcoin: click-to-pay handler");
    else
...
{
    // clicking on talkcoin: URLs creates FileOpen events on the Mac:
