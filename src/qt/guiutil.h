...
namespace GUIUtil
{
    ...
    // Render Talkcoin addresses in monospace font
    ...
    // See Talkcoin URI definition discussion here: https://talkcointalk.org/index.php?topic=33490.0
    ...
    */
    ...
    /** Help message for Talkcoin-Qt, shown with --help. */
